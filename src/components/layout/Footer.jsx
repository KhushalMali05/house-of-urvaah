...
export const Footer = () => {
  return (
    <footer className="bg-white text-brand-dark border-t border-neutral-300 pt-16 pb-12 px-6 sm:px-10 md:px-12 lg:px-16 font-serif w-full">
      <div className="max-w-[1800px] mx-auto">
        {/* 5-Column Grid Layout: Logo Block (Left) + 4 Link Columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 xl:gap-16 mb-16">
          {/* Column 1: LOGO & BRAND TAGLINE */}
          <div className="flex flex-col items-start pr-0 lg:pr-6">
            <Logo className="h-14 sm:h-18 md:h-20 lg:h-24" />
            <p className="text-[11px] md:text-xs tracking-[0.25em] text-neutral-400 uppercase mt-4 sm:mt-5 font-serif leading-relaxed">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 md:gap-4 text-neutral-700 mb-6">
              <a 
                href="https://instagram.com/houseofurvaah" 
                target="_blank" 
                rel="noopener noreferrer" 
                aria-label="Instagram" 
                className="hover:text-black hover:bg-neutral-200 transition-colors p-2 bg-neutral-100 rounded-full flex items-center justify-center"
              >
        ...
        <div className="pt-8 border-t border-neutral-300 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-neutral-400 tracking-widest uppercase">
